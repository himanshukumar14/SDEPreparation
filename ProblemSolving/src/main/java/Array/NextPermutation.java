 ...
 * 
 * 
 * Problem Constraints 1 <= N <= 5 * 105
 * 
 * 1 <= A[i] <= 109
 * 
 * 
 * 
 * Input Format The first and the only argument of input has an array of
 * integers, A.
 * 
 * 
 * 
 * Output Format Return an array of integers, representing the next permutation
 * of the given array.
 * 
 * 
 * 
 ...
 * 
 * Next permutaion of [1, 2, 3] will be [1, 3, 2]. Explanation 2:
 * 
 * No arrangement is possible such that the number are arranged into the
 * numerically next greater permutation of numbers. So will rearranges it in the
