 ...
 * 
 * Input: p[] = {10, 20, 30, 40, 30} Output: 30000 There are 4 matrices of
 ...
 * 
 * Input: p[] = {10, 20, 30} Output: 6000 There are only two matrices of
 * dimensions 10x20 and 20x30. So there is only one way to multiply the
