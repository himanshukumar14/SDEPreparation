...
import CricketMatchDashboard.ui.Dashboard;
...
public class Match {
    ...
    public void addPlayersToTeam(Team team, List<Player> listOfPlayers) {
        if (listOfPlayers.size() > this.numOfPlayerInTeam) {
            System.out.println("No of players is more");
            return;
        }
        for (Player player : listOfPlayers) {
            team.addPlayersToTeam(new CricketPlayer(player.getName(), player.getGender(), player.getAge()));
        }
    }
