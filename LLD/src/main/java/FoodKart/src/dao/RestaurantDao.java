package FoodKart.src.dao;

import FoodKart.src.Exceptions.RestaurantAlreadyPresent;
import FoodKart.src.Exceptions.RestaurantNotPresent;
import FoodKart.src.model.Restaurant;
